...
public client class Client {
    ...
    public isolated function init(http:ClientConfiguration clientConfig =  {}, string serviceUrl = "http://localhost:8081/learningEnvironmentManagement") returns error? {
    ...
    remote isolated function  {course}Bylearner(string course, string learner) returns TopicObjectArr|error {
